...
describe MoteSMS::TwilioTransport do
  ...
  let(:result) { Twilio::REST::Message.new('/SMS', subject.client, from: '+41791110011', to: '41790001122', body: 'Hello World') }
  let(:results) { Twilio::REST::Messages.new('/SMS', subject.client) }
